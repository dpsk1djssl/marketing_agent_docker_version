...
- **임무 5: 핵심 고객 분석 및 메시지 제안 (특화 질문 1)**
  ...
  - **수행**: 기획서 분석 절차에 따라 다음 3단계를 수행합니다.
      ...
      3. **맞춤 메시지 생성 (STEP 3)**: 추론된 고객 특성에 맞춰, 해당 가맹점(요식업) 맥락에서 **가장 매력적이고 효과적일 것으로 예상되는 구체적인 마케팅 메시지 문구 예시** 2가지를 생성합니다. 메시지는 단순히 정보를 전달하는 것을 넘어, 고객의 감성이나 니즈를 자극하는 내용이어야 합니다.
